...
static unsigned char digit[] = {
    0xE7, 0x21, 0xCB, 0x6B, 0x2D, 0x6E, 0xEE, 0x23, 0xEF, 0x6F, 0x10, 0xE6
};
...
void main(void) {
    ...
    while (1) {
        ...
        ssd[1] = digit[speed % 10];
        ssd[0] = digit[(speed / 10) % 10];
        if (++count >= 200)
            count = 0;
        ...
        {
            prev_pos = gear_pos;
            can_transmit(0x20,(unsigned char *) gear_p[gear_pos], 1);
        }
